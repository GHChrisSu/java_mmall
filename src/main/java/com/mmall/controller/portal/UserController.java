...
//    用户登陆
    ...
    @RequestMapping(value = "check_volid.do", method = RequestMethod.POST)
    @ResponseBody
    public  ServerResponse<String> checkVolid(String str,String type){
        return iUserService.checkVolid(str,type);
    }

    @RequestMapping(value = "get_user_info.do", method = RequestMethod.POST)
    @ResponseBody
    public  ServerResponse<User> getUserInfo(HttpSession sesion){
        User user = (User)sesion.getAttribute(Const.CURRENT_USER);
        if(user!=null){
